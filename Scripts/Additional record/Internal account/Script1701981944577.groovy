...
WebUI.enhancedClick(findTestObject('Object Repository/Pages/Account Object/Internal/span_Corporate_slds-radio--faux'))

WebUI.click(findTestObject('Object Repository/Pages/Account Object/Internal/span_Next'))

WebUI.setText(findTestObject('Pages/Account Object/Internal/input__Name'), findTestData(
        'Create_contact').getValue(4, 1))

WebUI.click(findTestObject('Object Repository/Pages/Account Object/Internal/button_Save'))
